...
insert into  ebook (id, name,description) values (1, 'Spring Boot 入门教程','零基础入门 Java 开发，企业级应
用开发最佳首选框架');
insert into ebook (id,name, description) values (2, 'Vue 入门教程','零基础入门 Vue 开发，企业级应用开发最佳
首选框架');
insert into ebook (id, name, description) values (3,'Python 入门教程','零基础入门 Python 开发，企业级应用
开发最佳首选框架');
insert into ebook (id, name, description) values (4, 'Mysq1 入门教程','零基础入门 Mysq1 开发，企业级应用开发
最佳首选框架');
insert into ebook (id, name, description) values (5, 'Oracle 入门教程','零基础入门 oracle 开发，企业级应用
开发最佳首选框架');
...
insert into doc (id, ebook_id, parent, name, sort, view_count, vote_count) values(1,1,0,'文档1',2,0,0);
...
where ebook_snapshot.date=date_sub(curdate(),interval 1 day )) t2
